...
\input{misc/config.inc.tex}



% Hier diverse Daten angeben
\newcommand{\mytitle}{Intelligente Plattform - Priorisierung von E-Mails in der Inbox by Gmail}
\newcommand{\arbeit}{Bachelorarbeit \Romannum{1}}
\newcommand{\jahrgang}{Web Business \& Technology 2015}
\newcommand{\abgabedat}{06. Februar 2017}
...
%============================================================
\input{misc/config.pdf.tex}
\input{content/glossary} 	% Glossar, Abkürzungsverzeichnis und/oder Symbolverzeichnis

%============================================================
% Dokumentanfang und Titelei
%============================================================
\begin{document}
	\input{content/title} 	% Einbinden der Titelei
\pagenumbering{roman}
...
\clearpage
\onehalfspacing
	\input{content/exsummary} 	% Abstract
...
\pagenumbering{arabic}
	\input{content/mainmatter} 	% Hauptteil
...
\clearpage
\onehalfspacing
	\input{content/appendix} 	% Anhänge
