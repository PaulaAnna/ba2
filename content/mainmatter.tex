...
Wie bereits in der Ausgangssituation dieser Arbeit erläutert, sind Mobiltelefone und Internetzugang aus unserem alltäglichen Leben nicht mehr wegzudenken. Aus diesem Grund steigt auch das Angebot und die Nachfrage nach mobilen Applikationen, welche auf einem Smartphone oder Tablett heruntergeladen und installiert werden können, damit sie überall verwendet werden können. Die angebotenen Applikationen können von kleinen Dienstprogrammen reichen, die nur eine kleines Problem lösen beziehungsweise nur eine Funktion haben, bis hin zu großen Programmpaketen, welche komplexe Funktionen haben. Die Anzahl der Applikationen in den jeweiligen Appstores ist heutzutage schier unüberschaubar. Die Applikationen müssen nach dem zur Grunde liegendem Betriebssystem, auf dem sie laufen müssen, ausgesucht werden. Die zwei größten Betriebssysteme sind Android und iOS, wobei Android im Mai 2018 einen weltweiten Marktanteil von 76,53\% hat und iOS von 18,97\% hat\footcite{mobileos}. In Österreich sind die Zahlen etwas anderes, doch auch hier hat Android laut einer Statistik im März 2018 einen Marktanteil von 64,3\% und iOS einen Anteil von 34,7\%\footcite{stat}.
